...
def write_graflab_wrapper_m(
    ...
    *,
    ...
    coord=0, point_type=1,             # 1 = Load data
    lat_min=0, lat_step=0, lat_max=0,
    lon_min=0, lon_step=0, lon_max=0, h=0,
    Input_data_path="",
    Output_path=r"C:/salidas",
    Functional_or_Commission=0, Functional=(20,),
    fnALFs=1, DTM_path="",
    Export_data_txt=1, Export_report=1, Export_data_mat=0,
    Display_data=0, Graphic_format=0, Colormap=0,
    Number_of_colors=0, DPI=0,
    Status_bar=1,
):
    ...
    function {func_name}()
    % -------------------------------------------------
    % Generado automáticamente (batch-safe)
    % -------------------------------------------------

    addpath(genpath({_matlab_quote(graflab_path)}));
...
def remover_puntual(
    *,
    ...
    m1_path = write_graflab_wrapper_m(
        ...
        Output_path=str(out1), Functional_or_Commission=0, Functional=(5,), fnALFs=1,
        Export_data_txt=1, Export_report=1, Export_data_mat=0,
    ...
    m2_path = write_graflab_wrapper_m(
        ...
        Output_path=str(out2), Functional_or_Commission=0, Functional=(5,), fnALFs=1,
        Export_data_txt=1, Export_report=1, Export_data_mat=0,
        Display_data=0, Graphic_format=0, Colormap=0, Number_of_colors=0, DPI=0, Status_bar=1,
    )
    ...
    m3_path = write_graflab_wrapper_m(
        ...
        Output_path=str(out3), Functional_or_Commission=0, Functional=(5,), fnALFs=1,
        Export_data_txt=1, Export_report=1, Export_data_mat=0,
        Display_data=0, Graphic_format=0, Colormap=0, Number_of_colors=0, DPI=0, Status_bar=1,
    )
